  ...
  return (
    <div className="step-content completion-content">
      ...
      <div className="completion-header">
        ...
        <p>
          Floworx is now monitoring your Gmail and will start categorizing and 
          routing your emails automatically. You should see results within minutes!
        </p>
      </div>
      ...
      <div className="completion-footer">
        <div className="support-info">
          ...
          <p>
            ...
            <a href="https://docs.floworx-iq.com" target="_blank" rel="noopener noreferrer"> View Documentation</a>
          </p>
        </div>
