  ...
  return (
    <div className='min-h-screen bg-surface-soft p-8'>
      <div className='max-w-6xl mx-auto space-y-8'>
          ...
          <Card.Content>
            <div className='grid grid-cols-2 md:grid-cols-4 gap-6'>
              ...
              <div className='space-y-3'>
                ...
                <div className='space-y-2'>
                  <div className='flex items-center space-x-3'>
                    <div className='w-8 h-8 bg-brand-primary rounded-lg border border-surface-border' />
                    <span className='text-sm text-ink-sub'>Primary</span>
                  </div>
                  <div className='flex items-center space-x-3'>
                    <div className='w-8 h-8 bg-brand-primary-hover rounded-lg border border-surface-border' />
              ...
              <div className='space-y-3'>
                ...
                <div className='space-y-2'>
                  <div className='flex items-center space-x-3'>
                    <div className='w-8 h-8 bg-ink rounded-lg border border-surface-border' />
                    <span className='text-sm text-ink-sub'>Ink</span>
                  </div>
                  <div className='flex items-center space-x-3'>
                    <div className='w-8 h-8 bg-ink-sub rounded-lg border border-surface-border' />
                    <span className='text-sm text-ink-sub'>Sub</span>
                  </div>
                  <div className='flex items-center space-x-3'>
                    <div className='w-8 h-8 bg-surface-subtle rounded-lg border border-surface-border' />
              ...
              <div className='space-y-3'>
                ...
                <div className='space-y-2'>
                  <div className='flex items-center space-x-3'>
                    <div className='w-8 h-8 bg-success rounded-lg border border-surface-border' />
                    <span className='text-sm text-ink-sub'>Success</span>
                  </div>
                  <div className='flex items-center space-x-3'>
                    <div className='w-8 h-8 bg-warning rounded-lg border border-surface-border' />
                    <span className='text-sm text-ink-sub'>Warning</span>
                  </div>
                  <div className='flex items-center space-x-3'>
                    <div className='w-8 h-8 bg-danger rounded-lg border border-surface-border' />
                    <span className='text-sm text-ink-sub'>Danger</span>
                  </div>
                  <div className='flex items-center space-x-3'>
                    <div className='w-8 h-8 bg-info rounded-lg border border-surface-border' />
            ...
            <div className='space-y-6'>
              ...
              <div>
                ...
                <div className='space-x-2'>
                  <Button size='sm' onClick={() => handleShowToast('success')}>
                    Success Toast
                  </Button>
                  <Button size='sm' onClick={() => handleShowToast('warning')}>
                    Warning Toast
                  </Button>
                  <Button size='sm' onClick={() => handleShowToast('danger')}>
                    Error Toast
                  </Button>
        ...
        {/* Toast Component */}
        {showToast && (
          <Toast variant={toastVariant} onClose={() => setShowToast(false)} duration={3000}>
