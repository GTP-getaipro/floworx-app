...
// Inlined production monitoring configuration (moved from ../config/production-monitoring.js)
...
// Inlined business alerting rules (moved from ../config/business-alerting-rules.js)
const _businessAlertingRules = {
