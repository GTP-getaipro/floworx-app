    ...
    return (
      <div className="step-content">
        ...
        <div className="step-actions">
          <button 
            onClick={() => onComplete({ googleConnected: true })}
    ...
    <div className="step-content">
      <div className="welcome-content">
        ...
        <p className="welcome-description">
          Transform your business email management with AI-powered automation. 
          Let's connect your Google Workspace account to get started with intelligent 
          email categorization and automated responses.
        </p>
      ...
      <div className="security-note">
        ...
        <small>
          Your data is encrypted and secure. We never store your passwords and 
