            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              <div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center space-x-3">
                    <div className="w-8 h-8 bg-brand-primary-hover rounded"></div>
              ...
              <div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center space-x-3">
                    <div className="w-8 h-8 bg-surface border border-surface-border rounded"></div>
          ...
          <Card.Content>
            <div className="space-y-4">
              <div className="flex flex-wrap gap-4">
                <Link to="/dashboard" variant="primary">Primary Link</Link>
                <Link to="/settings" variant="secondary">Secondary Link</Link>
                <Link to="/help" variant="muted">Muted Link</Link>
                <Link href="https://example.com" external variant="primary">External Link</Link>
              </div>
            </div>
          </Card.Content>
        </Card>
