    ...
    .items(
      Joi.object({
        ...
        workflowTrigger: Joi.string()
          ...
          .required()
          .messages({
            'any.only': 'Workflow trigger must be one of: new_customer, service_request, complaint, inquiry, booking, other',
...
const completeOnboardingSchema = Joi.object({
  ...
  finalReview: Joi.object({
    businessInfoConfirmed: Joi.boolean()
      .valid(true)
      .required()
      .messages({
    ...
    gmailConnectionConfirmed: Joi.boolean()
      .valid(true)
      .required()
      .messages({
    ...
    labelMappingsConfirmed: Joi.boolean()
      .valid(true)
      .required()
      .messages({
    ...
    notificationsConfirmed: Joi.boolean()
      .valid(true)
      .required()
      .messages({
...
const updateOnboardingSessionSchema = Joi.object({
  ...
  stepData: Joi.object()
    .optional(),
  completedSteps: Joi.array()
    .items(Joi.string())
    .optional(),
  status: Joi.string()
    .valid('in_progress', 'completed', 'abandoned', 'error')
    .optional()
    .messages({
