...
describe('Business Types API', () => {
  ...
  describe('GET /api/business-types', () => {
    ...
    it('should handle database errors gracefully', async () => {
      ...
      const originalGetBusinessTypes = require('../../backend/database/database-operations').databaseOperations.getBusinessTypes;
      
      require('../../backend/database/database-operations').databaseOperations.getBusinessTypes = jest.fn()
      ...
      require('../../backend/database/database-operations').databaseOperations.getBusinessTypes = originalGetBusinessTypes;
    });
  });
