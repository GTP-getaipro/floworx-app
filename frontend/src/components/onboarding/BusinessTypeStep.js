...
const BusinessTypeStep = ({ onNext, onBack, stepData, onStepDataChange }) => {
    ...
    return (
      <div className="max-w-4xl mx-auto p-6">
        <div className="text-center mb-8">
          ...
          <p className="text-ink-sub">We'll customize your email automation based on your industry.</p>
        </div>
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      <div className="text-center mb-8">
        <h2 className="text-2xl font-bold text-ink mb-2">Select Your Business Type</h2>
        <p className="text-ink-sub">We'll customize your email automation workflows based on your industry's specific needs.</p>
      </div>
            ...
            >
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {businessType.default_categories && businessType.default_categories.length > 0 && (
                    <div className="mt-4">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {businessType.default_categories.slice(0, 3).map((category, index) => (
                          <Badge
                            key={index}
                            variant={category.priority === 'high' ? 'danger' : category.priority === 'medium' ? 'warning' : 'default'}
                            size="sm"
                          >
                            {category.name}
                          </Badge>
