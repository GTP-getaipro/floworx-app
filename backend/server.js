...
const envCheckRoutes = require('./routes/env-check'); // TEMPORARY - DELETE AFTER DEBUGGING
const testRegistrationRoutes = require('./routes/test-registration'); // TEMPORARY - DELETE AFTER DEBUGGING
...
app.use('/api/env-check', envCheckRoutes); // TEMPORARY - Environment variables check
app.use('/api/test-registration', testRegistrationRoutes); // TEMPORARY - Registration debugging
