  ...
  return (
    <div className="space-y-6">
      ...
      <Alert variant="warning">
        <strong>Emergency Access Notice:</strong> This will grant you temporary access to your account with limited functionality. You must complete full account recovery to restore normal access.
      </Alert>
        ...
        <Card.Content>
          <div className="space-y-3">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-sm text-ink">View your dashboard and basic account information</span>
            </div>
            <div className="flex items-center space-x-3">
              <div className="w-2 h-2 bg-success rounded-full"></div>
              <span className="text-sm text-ink">Access your email automation settings (read-only)</span>
            </div>
            <div className="flex items-center space-x-3">
              <div className="w-2 h-2 bg-success rounded-full"></div>
              <span className="text-sm text-ink">Reset your password and update security settings</span>
            </div>
            <div className="flex items-center space-x-3">
              <div className="w-2 h-2 bg-success rounded-full"></div>
        ...
        <label className="flex items-start space-x-3 cursor-pointer">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-ink-sub mt-1">
              I acknowledge that this is temporary access with restricted functionality, and I must complete full account recovery to restore normal access to my FloWorx account.
            </p>
          </div>
        </label>
      </div>
