...
const Alert = ({ 
  ...
  const variants = {
    success: {
      container: 'bg-surface-soft border-l-4 border-success text-ink',
      icon: (
    ...
    warning: {
      container: 'bg-surface-soft border-l-4 border-warning text-ink',
      icon: (
    ...
    danger: {
      container: 'bg-surface-soft border-l-4 border-danger text-ink',
      icon: (
    ...
    info: {
      container: 'bg-surface-soft border-l-4 border-info text-ink',
      icon: (
    ...
    <div className={`rounded-lg p-4 ${container} ${className}`}>
      <div className="flex">
        ...
        <div className="ml-3 flex-1">
          {title && (
            <h3 className="text-sm font-medium mb-1 text-ink">
              {title}
            </h3>
          )}
