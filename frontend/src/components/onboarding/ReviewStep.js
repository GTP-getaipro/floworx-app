    ...
    <div className="step-content">
                ...
                <div key={index} className="review-item team-item">
                  <div className="member-details">
                    ...
                    <div className="member-scope">
                      {member.categoryName ? `Notified for: ${member.categoryName}` : 'All categories'}
                    </div>
                  </div>
          ...
          <div className="automation-flow">
            <div className="flow-step">
              ...
              <div className="flow-content">
                ...
                <div className="flow-description">We'll monitor your Gmail inbox every 5 minutes</div>
              </div>
            </div>
            ...
            <div className="flow-step">
              ...
              <div className="flow-content">
                ...
                <div className="flow-description">Emails are automatically categorized using AI</div>
              </div>
            </div>
            ...
            <div className="flow-step">
              ...
              <div className="flow-content">
                ...
                <div className="flow-description">Emails are labeled according to your mappings</div>
              </div>
            </div>
      ...
      <div className="activation-note">
        ...
        <div className="note-content">
          <strong>Ready to go live?</strong> Once activated, your email automation will start working immediately. 
